        ...
        <div class="container">
            <div class="row fullscreen d-flex align-items-center justify-content-center">
                <div class="banner-content col-lg-12">
                    ...
                    <p class="text-white"> <span>Search by tags:</span> Tecnology, Business, Consulting, IT
                        Company, Design, Development</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row align-items-center">
                <div class="active-popular-post-carusel">
                    <div class="single-popular-post d-flex flex-row">
                        <div class="thumb">
                            <img class="img-fluid" src="${urlPublic}/img/p1.png" alt="">
                    ...
                    <div class="single-popular-post d-flex flex-row">
                        <div class="thumb">
                            <img src="${urlPublic}/img/p1.png" alt="">
                            <a class="btns text-uppercase" href="#">view job post</a>
                        </div>
                        <div class="details">
                            <a href="#">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-2 col-md-4 col-sm-6">
                    <div class="single-fcat">
                        <a href="category.html">
                            <img src="${urlPublic}/img/o1.png" alt="">
                        </a>
                        <p>Accounting</p>
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 col-sm-6">
                    <div class="single-fcat">
                        <a href="category.html">
                            <img src="${urlPublic}/img/o2.png" alt="">
                        </a>
                        <p>Development</p>
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 col-sm-6">
                    <div class="single-fcat">
                        <a href="category.html">
                            <img src="${urlPublic}/img/o3.png" alt="">
                        </a>
                        <p>Technology</p>
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 col-sm-6">
                    <div class="single-fcat">
                        <a href="category.html">
                            <img src="${urlPublic}/img/o4.png" alt="">
                        </a>
                        <p>Media & News</p>
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 col-sm-6">
                    <div class="single-fcat">
                        <a href="category.html">
                            <img src="${urlPublic}/img/o5.png" alt="">
                        </a>
                        <p>Medical</p>
                    </div>
                </div>
                <div class="col-lg-2 col-md-4 col-sm-6">
                    <div class="single-fcat">
                        <a href="category.html">
                            <img src="${urlPublic}/img/o6.png" alt="">
                        </a>
                        <p>Goverment</p>
                    </div>
                </div>
            ...
            <div class="row justify-content-center d-flex">
                <div class="col-lg-8 post-list">
                    ...
                    <div class="single-post d-flex flex-row">
                        <div class="thumb">
                            <img src="${urlPublic}/img/post.png" alt="">
                            <ul class="tags">
                                <li>
                                    <a href="#">Art</a>
                                </li>
                    ...
                    <a class="text-uppercase loadmore-btn mx-auto d-block" href="category.html">Load More
                        job Posts</a>
                ...
                <div class="col-lg-4 sidebar">
                    ...
                    <div class="single-slidebar">
                        ...
                        <div class="active-relatedjob-carusel">
                            <div class="single-rated">
                                <img class="img-fluid" src="${urlPublic}/img/r1.jpg" alt="">
                                <a href="single.html">
                                    <h4>Creative Art Designer</h4>
                                </a>
                                <h6>Premium Labels Limited</h6>
                    ...
                    <div class="single-slidebar">
                        ...
                        <div class="blog-list">
                            <div class="single-blog " style="background:#000 url(${urlPublic}/img/blog1.jpg);">
                                <a href="single.html">
                            ...
                            <div class="single-blog " style="background:#000 url(${urlPublic}/img/blog2.jpg);">
                                <a href="single.html">
                                    <h4>Home Audio Recording <br>
                                        For Everyone</h4>
                                </a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 download-left">
                    <img class="img-fluid" src="${urlPublic}/img/d1.png" alt="">
                </div>
